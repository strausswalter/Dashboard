...
// Abaixo a função Login recebe direto a função { setCurrentRoute } ( entre chaves ).
// 2a forma de receber:
    // const Login = (props)
    // ...
...
const Login = ({ setCurrentRoute }) => { // Recebe direto a função. Se passar mais, separar por virgula.
